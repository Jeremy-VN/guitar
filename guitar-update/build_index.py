...
SECTIONS = [
    ...
    },
    {
        ...
        "kind": "Theory",
        "title": "Music Theory",
        "summary": "General theory, not tied to a single lesson &mdash; starting with a full "
                   "breakdown of the modes: how each one sounds, the genres it suits, and example tracks.",
        "tags": ["Modes", "Scales", "Harmony"],
        "open": "Open theory",
    },
    {
